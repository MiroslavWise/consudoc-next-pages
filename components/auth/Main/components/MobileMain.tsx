...
import { isAndroid, isIOS, isIOS13, isIPhone13, isIPod13, isIPad13, isSamsungBrowser } from "react-device-detect"
...
const MobileMain = () => {
    ...
    return (
        <main className={styles.wrapper}>
            <section>
                <Image src="/svg/logo-full.svg" alt="main-logo" width={244} height={50} className={styles.logo} unoptimized />
            ...
            <footer>
                <button data-regular onClick={() => handleReplace("?state=login")}>
                    <span>{t("Enter")}</span>
                </button>
                <button data-fill onClick={() => handleReplace("?state=registration")}>
